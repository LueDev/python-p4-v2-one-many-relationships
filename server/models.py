...
class Employee(db.Model):
    ...
    # OLD: reviews = db.relationship('Review', back_populates="employee")
    ...
    # uselist=False : 
    # This ensures the relationship maps to a single related object rather than a list.
    # OLD: onboarding = db.relationship('Onboarding', uselist=False, back_populates='employee')
